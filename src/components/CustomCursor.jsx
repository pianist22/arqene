...
export default function CustomCursor() {
  ...
  const [variant, setVariant] = useState("default"); // only for class changes
  ...
  useEffect(() => {
    ...
    const enterSmall = () => {
      variantRef.value = "small";
      setVariant("small");
    };
    const leaveSmall = () => {
      variantRef.value = "default";
      setVariant("default");
    };
  ...
  const size = variant === "default" ? 28 : 10;
